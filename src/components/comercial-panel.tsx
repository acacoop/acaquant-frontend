...
export function ComercialPanel() {
  ...
  return (
    <div className="h-full flex flex-col min-h-0 p-3 gap-3">
      ...
      {/* Tabla por operador */}
      <div className="flex-1 min-h-0 border border-[#1a1a1a] bg-[#080808] overflow-auto">
        <table className="w-full text-[11px]">
          ...
          <tbody>
            ...
            {data?.operadores.map((o, i) => (
              <tr key={o.operador_email ?? `sin-${i}`} className="border-t border-[#141414] hover:bg-[#0e0e0e]">
