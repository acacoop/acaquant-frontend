...
// Proxy /api/mm → backend FastAPI. Acepta GET (trades-dia, fechas) y
// POST (backtest). Propaga x-acaquant-user-email para que el backend
// pueda gatear con require_module('mm').
...
async function proxy(req: Request, path: string[]) {
  try {
    ...
    // por service token; mandamos x-acaquant-user-email también.
