...
|---|---|---|
| **AHORA** | los hallazgos de **HOY** sin leer y sin resolver — **el aviso del AV AGENT y nada más**: la conclusión de la IA no se dibuja acá (pedido del user), sólo un botón que lleva al LAB | ✓ leído · **✕ silenciar** · diagnosticar / ver diagnóstico → LAB |
